...
class MyGame(arcade.View):
    ...
    def setup(self):
        ...
        for coordinate in coordinate_list:
            ...
            wall = arcade.Sprite("assets\chest.png", .1)
            wall.position = coordinate
            self.wall_list.append(wall)
        flag = arcade.Sprite("assets\\flag.jpg", 1)
        flag.position = [1280, 196]
    ...
    def on_update(self, delta_time):
        ...
        if not self.game_over:
            self.game_over = arcade.check_for_collision_with_list(self.player_sprite, self.flag)
        if self.game_over:
            end = gameOver()
...
class mainMenu(arcade.View):
    ...
    def on_draw(self):
        arcade.start_render()
        arcade.draw_text("Pirate Flag", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, arcade.color.BLACK, 
